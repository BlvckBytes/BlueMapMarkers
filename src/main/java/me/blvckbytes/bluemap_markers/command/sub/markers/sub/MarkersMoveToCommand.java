...
public class MarkersMoveToCommand extends SubCommand {
  ...
  public List<String> getPartialUsages(@Nullable Queue<NormalizedConstant<?>> actions, CommandSender sender) {
    return List.of(getCorrespondingAction().getNormalizedName() + " <Name> <x> <y> <z>");
  }

  @Override
  public NormalizedConstant<?> getCorrespondingAction() {
    return MarkersAction.matcher.getNormalizedConstant(MarkersAction.MOVE_TO);
  }
}
