...
public class MarkersSetSetCommand extends SubCommand {
  ...
  public List<String> getPartialUsages(@Nullable Queue<NormalizedConstant<?>> actions, CommandSender sender) {
    return List.of(getCorrespondingAction().getNormalizedName() + " <Name> <Set>");
  }

  @Override
  public NormalizedConstant<?> getCorrespondingAction() {
    return MarkersAction.matcher.getNormalizedConstant(MarkersAction.SET_SET);
  }
}
