...
public class MarkersSetVariableCommand extends SubCommand {
  ...
  public List<String> getPartialUsages(@Nullable Queue<NormalizedConstant<?>> actions, CommandSender sender) {
    return List.of(getCorrespondingAction().getNormalizedName() + " <Name> <Variable> <Value>");
  }

  @Override
  public NormalizedConstant<?> getCorrespondingAction() {
    return MarkersAction.matcher.getNormalizedConstant(MarkersAction.SET_VARIABLE);
  }
}
